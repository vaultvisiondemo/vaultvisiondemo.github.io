...
This is a demo project used to show how to create a static HTML/JS site that can still have access to user authentication and dynamic data via Airtable
